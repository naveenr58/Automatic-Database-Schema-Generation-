...
function loadImages() {
	...
	onImages[1].src	 = '/httpadmin/pics/structure2.jpg';
	onImages[2].src  = '/httpadmin/pics/properties2.jpg';
	onImages[3].src  = '/httpadmin/pics/browse2.jpg';
	onImages[4].src  = '/httpadmin/pics/sql2.jpg';
	onImages[5].src  = '/httpadmin/pics/import2.jpg';
	onImages[6].src  = '/httpadmin/pics/insert2.jpg';
	onImages[7].src  = '/httpadmin/pics/export2.jpg';
	onImages[8].src  = '/httpadmin/pics/operations2.jpg';
	onImages[9].src  = '/httpadmin/pics/search2.jpg';
	onImages[10].src = '/httpadmin/pics/login2.jpg';
	onImages[11].src = '/httpadmin/pics/reset2.jpg';
	onImages[12].src = '/httpadmin/pics/fetch2.jpg';
	onImages[13].src = '/httpadmin/pics/go2.jpg';
	onImages[14].src = '/httpadmin/pics/add2.jpg';
	onImages[15].src = '/httpadmin/pics/change2.jpg';
	onImages[16].src = '/httpadmin/pics/remove2.jpg';
	onImages[17].src = '/httpadmin/pics/create2.jpg';
	onImages[18].src = '/httpadmin/pics/apply2.jpg';
	onImages[19].src = '/httpadmin/pics/drop2.jpg';
	onImages[20].src = '/httpadmin/pics/empty2.jpg';
	onImages[21].src = '/httpadmin/pics/run2.jpg';
	onImages[22].src = '/httpadmin/pics/export12.jpg';
	onImages[23].src = '/httpadmin/pics/import12.jpg';
	onImages[24].src = '/httpadmin/pics/search12.jpg';

	offImages[1].src  = '/httpadmin/pics/structure1.jpg';
	offImages[2].src  = '/httpadmin/pics/properties1.jpg';
	offImages[3].src  = '/httpadmin/pics/browse1.jpg';
	offImages[4].src  = '/httpadmin/pics/sql1.jpg';
	offImages[5].src  = '/httpadmin/pics/import1.jpg';
	offImages[6].src  = '/httpadmin/pics/insert1.jpg';
	offImages[7].src  = '/httpadmin/pics/export1.jpg';
	offImages[8].src  = '/httpadmin/pics/operations1.jpg';
	offImages[9].src  = '/httpadmin/pics/search1.jpg';
	offImages[10].src = '/httpadmin/pics/login1.jpg';
	offImages[11].src = '/httpadmin/pics/reset1.jpg';
	offImages[12].src = '/httpadmin/pics/fetch1.jpg';
	offImages[13].src = '/httpadmin/pics/go1.jpg';
	offImages[14].src = '/httpadmin/pics/add1.jpg';
	offImages[15].src = '/httpadmin/pics/change1.jpg';
	offImages[16].src = '/httpadmin/pics/remove1.jpg';
	offImages[17].src = '/httpadmin/pics/create1.jpg';
	offImages[18].src = '/httpadmin/pics/apply1.jpg';
	offImages[19].src = '/httpadmin/pics/drop1.jpg';
	offImages[20].src = '/httpadmin/pics/empty1.jpg';
	offImages[21].src = '/httpadmin/pics/run1.jpg';
	offImages[22].src = '/httpadmin/pics/export11.jpg';
	offImages[23].src = '/httpadmin/pics/import11.jpg';
	offImages[24].src = '/httpadmin/pics/search11.jpg';
}
...
function submitEditForm(theForm,theList) {
	...
	if(sel)	{
		theForm.action = '/httpadmin/EditForm';
		theForm.submit();
	}
...
function submitBDropForm(theForm,theList) {
	...
	if(sel)	{
		...
		if(confirmed) {
			theForm.action = '/httpadmin/DropRecords';
			theForm.submit();
		}
	}
...
function callEmptyTab(tableName) {
	...
	if(confirmed) window.parent.right.location.href = "/httpadmin/EmptyTab?table_name=" + tableName;
}

function callDropTab(tableName) {
	var confirmed = confirm("Do you really want to delete '" + tableName + "' table.");
	if(confirmed) window.parent.right.location.href = "/httpadmin/DropTab?table_name=" + tableName;
}
...
function callExportDB(id) {
	...
	if(value != 0) window.parent.right.location.href = "/httpadmin/ExportDB?table_name=" + value;
}
